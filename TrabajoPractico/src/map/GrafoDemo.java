...
public class GrafoDemo {
	...
	public static void main(String[] args) {
		...
		Vertice A = new Vertice("A", new Troop(Alignment.Propio));
		Vertice B = new Vertice("B", new Troop(Alignment.Aliado));
		Vertice C = new Vertice("C", new Troop(Alignment.Aliado));
		Vertice D = new Vertice("D", new Troop(Alignment.Enemigo));
		Vertice E = new Vertice("E", new Troop(Alignment.Enemigo));
